...
version: 2.5.1
author: Siqi Chen (@blader, https://github.com/blader/humanizer), ported by Codex
license: MIT
...
This skill is written for any agent runtime. Map file reading, file editing, search, command execution, web access, browser control, vision, delegation, scheduling, memory, and skill management to the host agent's native capabilities. Examples are illustrative; do not assume a vendor-specific tool name, shell, home directory, permission mode, or session format. Preserve the skill's workflow and safety checks when translating an example.
...
Also apply this skill to **your own** output when writing user-facing prose such as release notes, PR descriptions, docs, and summaries. agent's baseline voice already strips most of these, but a focused pass catches what slips through.

## How to use it in agent
...
**Marketing and blog clich茅s (same tell, different register):** at the end of the day, when it comes to, in a world where, moving forward, circle back, deep dive, game-changer, double down, take a step back, on the same page, make no mistake, it turns out, let me be clear, navigate (for challenges), lean into, unpack (before analysis), straightforward (to describe anything)
...
**Problem:** LLMs use em dashes (鈥? more than humans, mimicking "punchy" sales writing. In practice, most of these can be rewritten more cleanly with commas, periods, or parentheses.

**Before:**
> The term is primarily promoted by Dutch institutions鈥攏ot by the people themselves. You don't say "Netherlands, Europe" as an address鈥攜et this mislabeling continues鈥攅ven in official documents.
...
**Before:**
> 馃殌 **Launch Phase:** The product launches in Q3
> 馃挕 **Key Insight:** Users prefer simplicity
> 鉁?**Next Steps:** Schedule follow-up meeting
...
**Before 鈫?After:**
- "In order to achieve this goal" 鈫?"To achieve this"
- "Due to the fact that it was raining" 鈫?"Because it was raining"
- "At this point in time" 鈫?"Now"
- "In the event that you need help" 鈫?"If you need help"
- "The system has the ability to process" 鈫?"The system can process"
- "It is important to note that the data shows" 鈫?"The data shows"
...
>
> AI-assisted coding serves as an enduring testament to the transformative potential of large language models, marking a pivotal moment in the evolution of software development. In today's rapidly evolving technological landscape, these groundbreaking tools鈥攏estled at the intersection of research and practice鈥攁re reshaping how engineers ideate, iterate, and deliver, underscoring their vital role in modern workflows.
>
...
>
> - 馃挕 **Speed:** Code generation is significantly faster, reducing friction and empowering developers.
> - 馃殌 **Quality:** Output quality has been enhanced through improved training, contributing to higher standards.
> - 鉁?**Adoption:** Usage continues to grow, reflecting broader industry trends.
>
> While specific details are limited based on available information, it could potentially be argued that these tools might have some positive effect. Despite challenges typical of emerging technologies鈥攊ncluding hallucinations, bias, and accountability鈥攖he ecosystem continues to thrive. In order to fully realize this potential, teams must align with best practices.
>
